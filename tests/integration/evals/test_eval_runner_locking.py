...
class TestEvalRunnerLocking:
    ...
    def eval_runners(self):
        ...
        runners_dir = Path(__file__).parent.parent.parent.parent / "evals" / "runners"
    ...
    def test_eval_runners_immutable_header(self):
        ...
        runner_file = Path(__file__).parent.parent.parent.parent / "evals" / "runners" / "run_agent_system_prompt_eval.py"
    ...
    def test_no_modification_outside_eval_directory(self):
        ...
        eval_dir = Path(__file__).parent.parent.parent.parent / "evals"
