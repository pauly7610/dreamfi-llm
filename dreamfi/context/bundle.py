...
def persist_bundle(session: Session, bundle: ContextBundle) -> ContextBundleRow:
    """Persist a ContextBundle and its child rows as the canonical memory unit."""
    row = ContextBundleRow(
        ...
        entities=[
            ContextEntityRow(
                ...
                relationships_json=[
                    relation.model_dump() for relation in entity.relationships
                ],
            )
        ...
        claims=[
            ContextClaimRow(
                ...
                sot_id=claim.sot_id,
                citation_ids_json=list(claim.citation_ids),
        ...
        open_questions=[
            OpenQuestionRow(
                ...
                why_open=question.why_open,
                suggested_owner=question.suggested_owner,
            )
